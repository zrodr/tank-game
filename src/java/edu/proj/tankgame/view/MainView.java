package edu.proj.tankgame.view;

import edu.proj.tankgame.controller.GameKeyListener;
...
public class MainView {
    ...
    public MainView(ActionListener buttonListener, GameKeyListener keyListener) {
        ...
        StartMenuView startMenuView = new StartMenuView("Start Game", buttonListener);
        mainPanel.add(startMenuView, Screen.START_MENU_SCREEN.getScreenName());

        StartMenuView endMenuView = new StartMenuView("Restart Game", buttonListener);
